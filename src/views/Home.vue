...
import imagecontrole from '/epis/painel-de-controle.png'
import imagedash from '/epis/painel.png'
import imagedoc from '/epis/documentacao.png'
import capacete from '/epis/safety.png'
import colete from '/epis/high-visibility-vest.png'
import protetorauditivo from '/epis/headphone.png'
import glasses from '/epis/glasses.png'
import boot from '/epis/boot.png'
import gloves from '/epis/gloves.png'
import overall from '/epis/overall.png'
import mask from '/epis/mask.png'
import touca from '/epis/cap.png'
